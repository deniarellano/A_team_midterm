...
# ==========================================================================
# ==========================================================================
# Data Download — Updated for ACS 2019–2023 (5-Year Estimates)
#
# Changes from original:
#   - Hardcoded to Bay Area: Alameda (001), San Francisco (075),
#     San Mateo (081), Santa Clara (085) counties, California (state 06)
#   - ACS "current" year updated from 2018 → 2023
#   - ACS "lag" year updated from 2012 → 2019
#   - All output column suffixes updated (_18 → _23, _12 → _19)
#   - Removed 1990 and 2000 decennial Census pulls (not requested)
#   - Removed multi-state city logic (Memphis/Boston) — not needed
#   - city_name / sys.argv removed; script runs standalone
#   - Output filenames updated accordingly
#
# NOTE: The 2020 Census redrew tract boundaries. If you later need to
#   compare 2023 ACS data against pre-2020 decennial baselines, use an
#   NHGIS time-series crosswalk (nhgis.org) to harmonize geometries.
#
# ==========================================================================
# ==========================================================================
# ==========================================================================
